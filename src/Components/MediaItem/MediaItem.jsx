...
export default function MediaItem({ele}) {
    return (
        <>
           <div className='col-xs-6 col-sm-6 col-md-2 my-2 '>
            <Link to={`movie/${ele.id}`}>
            <div className='card'>
                    {ele.profile_path?<img src={`https://image.tmdb.org/t/p/w500`+ele.profile_path} className='h-100' alt="movie-image"/>:<img src={`https://image.tmdb.org/t/p/w500`+ele.poster_path} className='h-100' alt="movie-image"/>}            
