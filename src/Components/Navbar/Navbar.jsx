...
return (
    <div>
        <nav className="navbar navbar-expand-lg navbar-light bg-transparent NavbarStyle ">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className="right-nav  d-flex align-items-center ">
            <div className="socialMedia mx-lg-5">
                <a href="https://www.facebook.com"> <i className='fab fa-facebook mx-2 ' style={{cursor:"pointer",color:"blue"}}></i></a>
                <a href="https://www.instagram.com"><i className='fab fa-instagram mx-2 ' style={{cursor:"pointer",color:"red"}}></i></a>
                <a href="https://www.spotify.com"><i className='fab fa-spotify mx-2 ' style={{cursor:"pointer",color:"green"}}></i></a>
                <a href="https://www.youtube.com"><i className='fab fa-youtube mx-2 ' style={{cursor:"pointer",color:"red"}}></i></a>
